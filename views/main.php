...
<ul class="nav">
	...
	?>
	<li><a href="https://ya.werdictbot.com/" style="color: red">Яндекс</a> | </li>
...
foreach ($sites as $site) {
	...
	$e=explode('@',$domain);
	if(file_exists(dirname(dirname(__FILE__)).'/icons/'.$e[0].'.ico')){
		$ico='/icons/'.$e[0].'.ico';
	}else{
		$ico="https://favicon.yandex.net/favicon/".$e[0];
	}



	echo "<tr id=\"tr_$domain\"><td><a href=\"https://$domain/\" target=_blank><img class=fav src=\"$ico\" width=16 height=16></a> <a href=\"?site=$domain"; 
